...
var tfDrawerToggle = document.getElementById('tf-drawer-toggle');
var tfDrawerClose = document.getElementById('tf-drawer-close');
var tfBackdrop = document.getElementById('tf-backdrop');
var tfDrawer = document.getElementById('tf-drawer');
var tfDrawerBody = document.getElementById('tf-drawer-body');
var tfChipsFonts = document.getElementById('tf-chips-fonts');
var tfChipsDeco = document.getElementById('tf-chips-deco');
